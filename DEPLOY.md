...
> ⚠️ ยังเป็นโปรเจกต์สาธิต — **แพลตฟอร์มไม่ถือเงินและไม่จ่ายเงินออก** gateway เป็นการจำลอง
> ส่วนช่องแนบสลิปโอนเข้าบัญชีสตรีมเมอร์โดยตรงด้วยเงินจริง ทุกหน้าที่เกี่ยวกับเงินต้องคงแบนเนอร์
> ที่บอกความต่างนี้ไว้ — ห้ามย้อนกลับไปเป็น "ไม่รับเงินจริง" ขณะที่ `SLIP_DONATIONS_ENABLED` เปิดอยู่
