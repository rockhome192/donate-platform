...
**ผลที่ตามมา (แก้ 24 ส.ค. 2026): เลขบัญชีธนาคารไม่บังคับอีกต่อไป** สิ่งที่ต้องกรอกคือ
**เบอร์พร้อมเพย์ + ชื่อบัญชี** เท่านั้น เพราะ QR ที่ระบบพิมพ์เป็นพร้อมเพย์เสมอ และสลิป
ที่ QR นั้นสร้างไม่เคยระบุเลขบัญชี — สาขาที่เทียบเลขบัญชีจึงทำงานเฉพาะตอนที่คนโอน
ไม่สแกน QR แต่โอนเข้าเลขบัญชีตรง ๆ การบังคับกรอกจึงเป็นการขอข้อมูลที่โดเนทของ
สตรีมเมอร์คนนั้นไม่มีวันได้ใช้ กฎยังปิดตายเหมือนเดิม: **ปลายทางที่สลิประบุ ถ้าเราไม่ได้
เก็บไว้เทียบ = ปฏิเสธ** ไม่ใช่ปล่อยผ่าน และไม่ใช่บอกว่าโอนผิดบัญชี
